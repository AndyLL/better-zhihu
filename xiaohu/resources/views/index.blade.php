...
<!-- 	<nav>
	...
	<script type="text/ng-template" id="home.tpl">
		<div class="home center-container card" ng-controller="HomeController">
			...
			<div class="item-set">
				<div class="item  card-padding">
					<div class="vote"></div>
					<div class="item-content">
						<div class="content-act">XXX 赞同了该回答</div>
						<div class="title">JavaScript 有什么奇技淫巧？</div>
						<div class="content-owner">Roy Li
							<span class="desc">编程话题优秀回答者装配脑袋一路走好。</span>
						</div>
						<div class="content-main">
							简单来说javascript是这么一个语言:1、他爹创造它的时候,中意的是函数式,但是公司要他弄的像java一点.当然,最后这个语言其实更像c,算是c风格的函数式脚本语言,除了名字里面有个java.2、他爹只用了十天的时间完成这个语言,然后互联网花了十几年在这个语言羸…
						</div>
