...
<div class="home center-container card" ng-controller="HomeController">
	...
	<div class="hr"></div>
	<div class="item-set">
		<div ng-repeat="item in Timeline.data" class="item  card-padding clear-float">
			...
			<div class="item-content">
				...
				<div class="content-owner"> [:item.user.username:] <span class="desc">User Intro: [:item.user.intro:]</span> </div>
